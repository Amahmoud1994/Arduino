...
static const char MONGODELETEMSG[] = "mongodb_store_msgs/MongoDeleteMsg";
  ...
  class MongoDeleteMsgRequest : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t length_database = strlen( (const char*) this->database);
      ...
      uint32_t length_collection = strlen( (const char*) this->collection);
      ...
      uint32_t length_document_id = strlen( (const char*) this->document_id);
